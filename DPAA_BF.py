...
#BPP File reading
#file = open("BPP_100_100_0.1_0.7_6.txt", "r")
...
#random.shuffle(WEIGHTS)                     #lista randomizálása
#------------------------------------#
...
def checkBins(currentWeight):
    ...
    if(posAndValue[0] == 9999999 and posAndValue[1] == 9999999):
